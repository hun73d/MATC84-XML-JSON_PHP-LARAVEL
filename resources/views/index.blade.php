			...
			<div class="wrap-login100">
				...
				@if (isset($email))
					...
					<div class="login100-form">
						...
						<!-- TRECHO ADICIONADO -->
						<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
							<input class="input100" type="text" name="fone" value="{{ $fone }}" readonly placeholder="Email">
							<span class="focus-input100"></span>
							<span class="symbol-input100">
				...
				@else
					<form class="login100-form validate-form" method="POST" action="{{ route('cadastro.user') }}">
						@csrf
						<span class="login100-form-title">
							Cadastro de usuário MATC84 - Equipe XML + JSON
						</span>
						...
						<div class="wrap-input100 validate-input" data-validate = "Telefone é necessário">
							<input class="input100" type="text" name="fone" placeholder="Telefone (DDD + Número)">
							<span class="focus-input100"></span>
							<span class="symbol-input100">
								<i class="fa fa-phone" aria-hidden="true"></i>
							</span>
